(function ($) {
  ...
  var settings = {},
    ...
    LE = {
      solar: [
        ...
        { d: 20, m: 10, i: 'Ngày Phụ nữ Việt Nam' },
        ...
        { d: 28, m: 6, i: 'Ngày Gia đình Việt Nam' },
      ],
      lunar: [
        { d: 1, m: 1, i: 'Tết Nguyên Đán' },
        { d: 10, m: 1, i: 'Ngày Thần Tài' },
  ...
  function printCell(lunarDate, solarDate, solarMonth, solarYear) {
    var cellClass, solarClass, lunarClass, solarColor, ctitle
      cellClass = "ngaythang",
      solarClass = "t2t6",
      lunarClass = "am",
      ctitle = 'ctitle';
    ...
    // res += '  <div class="' +  + '">' + title + '</div>\n';
    res += '  <div class="' + ctitle + '">' + title + '</div>\n';
    res += '</td>\n';
    return res;
  }
